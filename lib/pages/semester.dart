...
class SemesterState extends State<Semester>{
 ...
 var url='https://api.myjson.com/bins/12n6z0';
  ...
  Books books;
  List<Color> gridColor=[Colors.deepPurpleAccent,Colors.deepOrangeAccent,Colors.redAccent,Colors.indigoAccent,Colors.black,Colors.greenAccent,Colors.blueAccent];
    ...
    Padding(
      ...
      child: InkWell(
        onTap: (){
         Navigator.push(
         context,
          MaterialPageRoute(builder: (context) => BooksList(books: books,sem: sem,)));
        },
              child: Container(
          height: 50.0,
          width: 50.0,
