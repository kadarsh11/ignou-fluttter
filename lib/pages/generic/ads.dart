...
class Ads {
  ...
  static set keywords(List<String> keywords){
    _keywords = keywords == null ? <String>['education', 'ignou'] : keywords;
  }
  ...
  static void setBannerAd({
    ...
    _bannerAd = BannerAd(
      adUnitId:  Ads.testing ? BannerAd.testAdUnitId : "--------Banner Add Id--------",
      size: size,
      targetingInfo: info,
  ...
  static void setFullScreenAd({
    ...
    _fullScreenAd = InterstitialAd(
      adUnitId:  Ads.testing ? InterstitialAd.testAdUnitId : "--------Inerstitial Add Id--------",
      targetingInfo: info,
